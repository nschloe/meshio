...
def test_mdpa(mesh, write_binary = False):
    def writer(*args, **kwargs):
        return meshio.mdpa_io.write(*args, write_binary=write_binary, **kwargs)

    helpers.write_read(writer, meshio.mdpa_io.read, mesh, 1.0e-15)
    return


def test_generic_io():
    helpers.generic_io("test.mdpa")
    # With additional, insignificant suffix:
    helpers.generic_io("test.0.mdpa")
    return
