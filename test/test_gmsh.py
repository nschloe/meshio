...
@pytest.mark.parametrize('mesh', [
    ...
    helpers.add_cell_data(helpers.tri_mesh, 1, num_tags=1),
    helpers.add_cell_data(helpers.tri_mesh, 3, num_tags=1),
    helpers.add_cell_data(helpers.tri_mesh, 9, num_tags=1),
