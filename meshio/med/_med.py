...
def write(filename, mesh, add_global_ids=True, compression="gzip", compression_opts=4):
    ...
    try:
        if len(mesh.point_tags_info) > 0:
            ...
            _write_families(node, mesh.point_tags_info, compression, compression_opts)
    ...
    try:
        if len(mesh.cell_tags_info) > 0:
            ...
            _write_families(element, mesh.cell_tags_info, compression, compression_opts)
    except AttributeError:
        pass
