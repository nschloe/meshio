...
_writer_map = {
    ...
    "gmsh2-ascii": (_gmsh, ("2",), {"write_binary": False}),
    "gmsh2-binary": (_gmsh, ("2",), {"write_binary": True}),
    "gmsh4-ascii": (_gmsh, ("4",), {"write_binary": False}),
    "gmsh4-binary": (_gmsh, ("4",), {"write_binary": True}),
    "med": (_med, (), {}),
    "medit": (_medit, (), {}),
    "dolfin-xml": (_dolfin, (), {}),
    "off": (_off, (), {}),
