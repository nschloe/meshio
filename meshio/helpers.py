...
def write(filename, mesh, file_format=None):
    ...
    d = {
        ...
        "xdmf-binary": lambda: xdmf_io.write(filename, mesh, data_format='Binary'),
        "xdmf3-binary": lambda: xdmf_io.write(filename, mesh, data_format='Binary'),
        "xdmf-hdf": lambda: xdmf_io.write(filename, mesh, data_format='HDF'),
        "xdmf3-hdf": lambda: xdmf_io.write(filename, mesh, data_format='HDF'),
        "xdmf-xml": lambda: xdmf_io.write(filename, mesh, data_format='XML'),
        "xdmf3-xml": lambda: xdmf_io.write(filename, mesh, data_format='XML'),
